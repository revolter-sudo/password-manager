...
export default function createRouter<Config extends BaseConfig>(
  ...
  return router({
    ...
    create: procedure
      ...
      .mutation(async ({ ctx, input }) =>
        checkMutate(db(ctx).user.create(input as any)),
      ),

    deleteMany: procedure
      .input($Schema.UserInputSchema.deleteMany.optional())
      .mutation(async ({ ctx, input }) =>
        checkMutate(db(ctx).user.deleteMany(input as any)),
      ),

    delete: procedure
      .input($Schema.UserInputSchema.delete)
      .mutation(async ({ ctx, input }) =>
        checkMutate(db(ctx).user.delete(input as any)),
      ),

    findFirst: procedure
      .input($Schema.UserInputSchema.findFirst.optional())
      .query(({ ctx, input }) =>
        checkRead(db(ctx).user.findFirst(input as any)),
      ),

    findMany: procedure
      .input($Schema.UserInputSchema.findMany.optional())
      .query(({ ctx, input }) =>
        checkRead(db(ctx).user.findMany(input as any)),
      ),

    findUnique: procedure
      .input($Schema.UserInputSchema.findUnique)
      .query(({ ctx, input }) =>
        checkRead(db(ctx).user.findUnique(input as any)),
      ),

    updateMany: procedure
      .input($Schema.UserInputSchema.updateMany)
      .mutation(async ({ ctx, input }) =>
        checkMutate(db(ctx).user.updateMany(input as any)),
      ),

    update: procedure
      .input($Schema.UserInputSchema.update)
      .mutation(async ({ ctx, input }) =>
        checkMutate(db(ctx).user.update(input as any)),
      ),
...
> {
  ...
  findMany: {
    useQuery: <
      ...
      TData = Array<Prisma.UserGetPayload<T>>,
    >(
